...
> **💡一句话价值**：一条命令拿到抖音公开的视频/作者/评论/热榜数据，直接输出结构化JSON——做选题分析、抖音增长、用户痛点、数据分析、市场调研、对标账号监控、评论舆情分析、热点追踪，不用再手动刷抖音。
...
2. **拿 TOKEN**：访问 [抖音机会研究技能](https://www.guaikei.com) 自助开通，配置环境变量 `GUAIKEI_API_TOKEN`
...
- 🌐 **自助开通 TOKEN / 查阅使用帮助**：[抖音数据研究技能](https://www.guaikei.com)（推荐，最快）
